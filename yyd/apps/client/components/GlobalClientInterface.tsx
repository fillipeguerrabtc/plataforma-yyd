...
export default function GlobalClientInterface() {
  ...
  if (isBackoffice) {
    console.log('❌ Backoffice detected, not rendering interface');
    return null;
  }
  ...
  return (
    <div style={{ position: 'fixed', zIndex: 9999 }}>
      {/* Botões de Navegação - Topo Direito */}
      <div style={{ position: 'fixed', top: '1rem', right: '1rem', zIndex: 9999, display: 'flex', gap: '0.75rem' }}>
        <button
          onClick={handleBack}
          style={{
            background: 'white',
      ...
      {/* Botão WhatsApp - Fixo à Esquerda */}
      <button
